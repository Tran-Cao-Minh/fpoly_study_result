...
let prodInCart = JSON.parse(localStorage.getItem('product_in_cart')); // tao mang gio hang
        ...
        let prodItem = `
            <li class="prod-item">
                <div class="contain-img">
                    <img src="${prodInCart[i].img_link}" alt="">
                </div>
                <div class="contain-inf">
                    <div class="prod-inf">
                        ...
                        <div class="old-price">
                            <span>${prodInCart[i].old_price}</span> đ
                        </div>
                    </div>
                    <div class="quantity">
                        <div class="handling">
...
function saveQuantityProdInCart(prodName, prodQuantity) {
    ...
    localStorage.setItem('product_in_cart', JSON.stringify(prodInCart));
}
// xoa san pham
